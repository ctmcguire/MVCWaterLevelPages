<?php
	...
	$reader = new HTMLReader('copyright.html');//Get the html file corresponding to this php file
	addHeaderFooter($reader, 'Copyright');//Add the header and footer to this page
