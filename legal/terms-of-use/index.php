<?php
	...
	$reader = new HTMLReader('terms-of-use.html');//Get the html file corresponding to this php file
	addHeaderFooter($reader, 'Terms of Use');//Add the header and footer to this page
