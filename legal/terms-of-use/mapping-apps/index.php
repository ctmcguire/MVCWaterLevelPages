<?php
	...
	$reader = new HTMLReader('mapping-apps.html');//Get the html file corresponding to this php file
	addHeaderFooter($reader, 'Mapping Applications Terms of Use');//Add the header and footer to this page
