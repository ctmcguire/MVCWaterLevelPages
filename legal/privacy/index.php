<?php
	...
	$reader = new HTMLReader('privacy.html');//Get the html file corresponding to this php file
	addHeaderFooter($reader, 'Privacy');//Add the header and footer to this page
